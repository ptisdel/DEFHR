...
header("Content-Type: application/vnd.ms-excel");
    ...
    INNER JOIN  `wp_gmna_postmeta` as horseinfo
    ON horses.id=horseinfo.post_id
    WHERE horses.post_type='horse' AND horseinfo.meta_key='status' AND (LCASE(horseinfo.meta_value)='available for adoption' OR LCASE(horseinfo.meta_value)='available for s.o.s.')) as status_table
